...
import com.datastax.spark.connector.cassandra._
import com.datastax.spark.connector.cassandra.SomeColumns
...
//    val conf = new SparkConf().setAppName("cassandra-example-hello")
    val conf = new SparkConf(true).set("spark.cassandra.connection.host", "10.0.1.68")//ip of cassandra
